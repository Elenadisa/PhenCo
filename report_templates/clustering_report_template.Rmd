...
**Figure 5**: (**Top**) ***Clusters size average for KEGG analysis***. (**Bottom**) ***Number of clusters for KEGG analysis***. The average size of clusters is very similar in all networks. However, the number of clusters varys. However, the number of clusters varies between real and random networks, being this greater in real networks. 
...
**Figure 8**: ***Number of clusters in which all their HPOs shared the same KEGG pathway***. The number of clusters in which all its HPO are enriched in the same funtional system is higher in real networks comparing to random models. 
...
**Figure 9**: For those clusters which have common KEGG enrichment: (**Top-Left**) ***Number of different OMIM diseases that have a perfect match with clusters***. (**Top-Right**) ***Number of different OMIM diseases that match with clusters except from one phenotype***. (**Botton-Left**) ***Number of clusters that have a perfect match with OMIM diseases***.  (**Botton-Left**) ***Number of clusters that match with OMIM diseases except from one phenotype***. High-confidence clusters have more clusters that match with OMIM diseases and those clusters coincide with more than one disease comparing with Low-confidece and with the it random models. The number of clusters and diseases increase when we allow a cluster match failure with respect to the disease. 
...
**Figure 10**: For those clusters which have common KEGG enrichment: (**Top-Left**) ***Number of different Orphanet diseases that have a perfect match with clusters***. (**Top-Right**) ***Number of different Orphanet diseases that match with clusters except from one phenotype***. (**Botton-Left**) ***Number of clusters that have a perfect match with Orphanet diseases***.  (**Botton-Left**) ***Number of clusters that match with Orphanet diseases except from one phenotype***.
...
**Figure 11**: (**Top**) ***Clusters size average for Reactome analysis***. (**Bottom**) ***Number of clusters for Reactome analysis***. The average size of clusters is very similar in all networks. However, the number of clusters varys. However, the number of clusters varies between real and random networks, being this greater in real networks.
...
**Figure 12**: (**Top-Left**) ***Number of different OMIM diseases that have a perfect match with clusters***. (**Top-Right**) ***Number of different OMIM diseases that match with clusters except from one phenotype***. (**Botton-Left**) ***Number of clusters that have a perfect match with OMIM diseases***.  (**Botton-Left**) ***Number of clusters that match with OMIM diseases except from one phenotype***. High-confidence clusters have more clusters that match with OMIM diseases and those clusters coincide with more than one disease comparing with Low-confidece and with the it random models. The number of clusters and diseases increase when we allow a cluster match failure with respect to the disease.
...
```
  ...
  **Figure 13**: (**Top-Left**) ***Number of different Orphanet diseases that have a perfect match with clusters***. (**Top-Right**) ***Number of different Orphanet diseases that match with clusters except from one phenotype***. (**Botton-Left**) ***Number of clusters that have a perfect match with Orphanet diseases***.  (**Botton-Left**) ***Number of clusters that match with Orphanet diseases except from one phenotype***.
...
**Figure 14**: ***Number of clusters in which all their HPOs shared the same Reactome pathway***. The number of clusters in which all its HPO are enriched in the same funtional system is higher in real networks comparing to random models. 
...
**Figure 15**: For those clusters which have common Reactome enrichment: (**Top-Left**) ***Number of different OMIM diseases that have a perfect match with clusters***. (**Top-Right**) ***Number of different OMIM diseases that match with clusters except from one phenotype***. (**Botton-Left**) ***Number of clusters that have a perfect match with OMIM diseases***.  (**Botton-Left**) ***Number of clusters that match with OMIM diseases except from one phenotype***. High-confidence clusters have more clusters that match with OMIM diseases and those clusters coincide with more than one disease comparing with Low-confidece and with the it random models. The number of clusters and diseases increase when we allow a cluster match failure with respect to the disease. 
...
**Figure 16**: For those clusters which have common Reactome enrichment: (**Top-Left**) ***Number of different Orphanet diseases that have a perfect match with clusters***. (**Top-Right**) ***Number of different Orphanet diseases that match with clusters except from one phenotype***. (**Botton-Left**) ***Number of clusters that have a perfect match with Orphanet diseases***.  (**Botton-Left**) ***Number of clusters that match with Orphanet diseases except from one phenotype***.
...
**Figure 17**: (**Top**) ***Clusters size average for GO analysis***. (**Bottom**) ***Number of clusters for GO analysis***. The average size of clusters is very similar in all networks. However, the number of clusters varys. However, the number of clusters varies between real and random networks, being this greater in real networks.
...
**Figure 18**: (**Top-Left**) ***Number of different OMIM diseases that have a perfect match with clusters***. (**Top-Right**) ***Number of different OMIM diseases that match with clusters except from one phenotype***. (**Botton-Left**) ***Number of clusters that have a perfect match with OMIM diseases***.  (**Botton-Left**) ***Number of clusters that match with OMIM diseases except from one phenotype***. High-confidence clusters have more clusters that match with OMIM diseases and those clusters coincide with more than one disease comparing with Low-confidece and with the it random models. The number of clusters and diseases increase when we allow a cluster match failure with respect to the disease.
...
**Figure 1**: (**Top-Left**) ***Number of different Orphanet diseases that have a perfect match with clusters***. (**Top-Right**) ***Number of different Orphanet diseases that match with clusters except from one phenotype***. (**Botton-Left**) ***Number of clusters that have a perfect match with Orphanet diseases***.  (**Botton-Left**) ***Number of clusters that match with Orphanet diseases except from one phenotype***.
...
**Figure 2**: ***Number of clusters in which all their HPOs shared the same GO pathway***. The number of clusters in which all its HPO are enriched in the same funtional system is higher in real networks comparing to random models. 
...
**Figure 3**: For those clusters which have common GO enrichment: (**Top-Left**) ***Number of different OMIM diseases that have a perfect match with clusters***. (**Top-Right**) ***Number of different OMIM diseases that match with clusters except from one phenotype***. (**Botton-Left**) ***Number of clusters that have a perfect match with OMIM diseases***.  (**Botton-Left**) ***Number of clusters that match with OMIM diseases except from one phenotype***. High-confidence clusters have more clusters that match with OMIM diseases and those clusters coincide with more than one disease comparing with Low-confidece and with the it random models. The number of clusters and diseases increase when we allow a cluster match failure with respect to the disease. 
...
**Figure 4**: For those clusters which have common GO enrichment: (**Top-Left**) ***Number of different Orphanet diseases that have a perfect match with clusters***. (**Top-Right**) ***Number of different Orphanet diseases that match with clusters except from one phenotype***. (**Botton-Left**) ***Number of clusters that have a perfect match with Orphanet diseases***.  (**Botton-Left**) ***Number of clusters that match with Orphanet diseases except from one phenotype***.
...
```{r  echo=FALSE, warning=FALSE, message=FALSE}
kable(ddply(metric_table, .(Type), summarize, "Clusters number" = mean(clusters_number_go_0.05), "Average cluster size" = mean(Average_Cluster_size_go_0.05), "Cluster OMIM overlap" = mean(clusters_with_omim_diseases_missing_1_go_0.05), "Cluster Orphanet overlap" = mean(clusters_with_orpha_diseases_missing_1_go_0.05), "Clusters functional coherent GO" = mean(clusters_enrich_70_percent_go_0.05), "Clusters functional coherent GO-OMIM overlap" = mean(clusters_with_omim_diseases_missing_1_enrich_70_percent_go_0.05), "Clusters functional coherent GO-Prphanet overlap" = mean(clusters_with_orpha_diseases_missing_1_enrich_70_percent_go_0.05)))
