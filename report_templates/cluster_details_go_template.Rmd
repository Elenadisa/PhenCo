...
#Load files add add hyperlinks
  ...
  hpo <- load_files_tab(metric_table, 'Type', 'Cluster_hpo_go_0.05', TRUE)
  ...
  go <- load_files_tab(metric_table, 'Type', 'Cluster_go_0.05', TRUE)
  ...
  omim <- load_files_tab(metric_table, 'Type', 'Cluster_omim_go_0.05', TRUE)  
...
#clusters_file
clusters_file_cytoscape <- load_files(metric_table, 'Type', 'cytoscape_file_go_0.05', FALSE)
